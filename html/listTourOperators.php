...
<body>
    ...
    <div class="operator">
        ...
        <form class="reviewForm" action="" method="post" class="pure-form">
            <label for="name">Enter your name</label>
            <input class="pure-input-rounded"type="text" name="name">
